...
tl_model = TransferLearningModel(data_loader.data_train_10_percent, data_loader.labels_train_10_percent, data_loader.data_test, data_loader.labels_test, num_classes=10)
